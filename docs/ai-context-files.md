...
SCM files can be auto-generated during gitvisor daily scans using the templates from specification repositories.
...
- [gitvisor STATE.scm](https://github.com/hyperpolymath/gitvisor/blob/main/STATE.scm) — Reference implementation
